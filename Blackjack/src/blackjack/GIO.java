...
/**
 * This module provides methods for obtaining user input and displaying
 * messages, using graphical dialog boxes rather than printed text.
 */
public class GIO {
    ...
    /**
     * Do not use this constructor. It is declared private to prevent its use.
     */
    private GIO() {
    }
}
